...
const ContactUs = (props) => {
  return (
    <main className="contact-us-container">
      <Helmet>
        <title>Contact-Us - XratedPress</title>
        <meta property="og:title" content="Contact-Us - XratedPress" />
      </Helmet>
      <header data-role="Header" className="contact-us-header">
        ...
        <nav className="contact-us-nav">
          ...
          <Link to="/contact-us" className="contact-us-navlink1">
            Contact Us
          </Link>
          <Link to="/shop" className="contact-us-navlink2">
            Shop
          </Link>
          <Link to="/about-us" className="contact-us-navlink3">
            About Us
          </Link>
        </nav>
        <div className="contact-us-container1">
          <div className="contact-us-btn-group">
            <Link to="/login" className="contact-us-register button">
              Login
            </Link>
            <Link to="/sign-up" className="contact-us-register1 button">
              Register
            </Link>
          </div>
        </div>
      ...
      <div className="contact-us-hero">
        ...
        >
          <h1 className="contact-us-text">Reach us!</h1>
          <Link to="/message-sent" className="contact-us-register2 button">
            Submit
          </Link>
          <span className="contact-us-name">Name:</span>
          <span className="contact-us-email">Email:</span>
          <span className="contact-us-contact-number">Contact Number:</span>
          <span className="contact-us-message">Message:</span>
          <input
            type="text"
            id="name"
            required
            placeholder="John Alexis"
            className="input contact-us-name1"
          />
          <input
            type="tel"
            id="num"
            ...
            className="input contact-us-number"
          />
          <input
            type="email"
            id="email"
            ...
            className="input contact-us-email1"
          />
          <textarea
            id="message"
            placeholder="Let us know your concern."
            className="textarea contact-us-textarea"
          ></textarea>
        </form>
        <img src="/external/picture1-1500h.png" className="contact-us-image2" />
      </div>
          ...
          <div className="contact-us-links-container">
            <div className="contact-us-container4">
              <div className="contact-us-product-container">
                <span className="contact-us-text02">Product</span>
                <Link to="/shop" className="contact-us-navlink4">
                  Shop
                </Link>
              </div>
              <div className="contact-us-company-container">
                <span className="contact-us-text03">Company</span>
                <Link to="/about-us" className="contact-us-navlink5">
                  About Us
                </Link>
                <Link to="/contact-us" className="contact-us-navlink6">
                  Contact Us
                </Link>
              </div>
            </div>
            <div className="contact-us-container5">
              <div className="contact-us-contact">
                <span className="contact-us-text04">Contact Us</span>
                <span className="contact-us-text05">
                  <span className="contact-us-text06">
              ...
              <div className="contact-us-socials">
                <span className="contact-us-text12">Follow Us</span>
                <div className="contact-us-icon-group1">
                  <a
